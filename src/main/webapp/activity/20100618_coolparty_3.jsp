...
String sTransdateFrom = "2010-06-01";	// should be 2010-03-16
...
<tr>
<td>2010-07-02</td>
<td>报表修改,过滤非酷党消费的记录。(jessica需求)</td>
</tr>
<tr>
<td>2010-06-22</td>
<td>酷党三期活动报表上线。</td>
...
// 1) will be returned.
String sqlMatchActivityTarget = "SELECT * FROM clubpoint WHERE " + spendingFilter + " AND  shopid IN (" + shopFilter + ") "+ " AND tempmembertxid IN (";
