...
String sTransdateFrom = "2010-12-01";	// should be 2010-03-16
String sTransdateTo = "2011-01-01";		// should be 2010-06-01, exclusive
// sHighlightTransaction: For transactions made on or after this day, 
// they will be highlighted with color
String sHighlightTransactionSince = "2010-11-01";
...
<html>
<head>
<title>2010-12-01 太平洋影院第三季活动报表</title>
<style type="text/css">
.mgrp_sep {
