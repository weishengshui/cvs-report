...
<%
	...
	GregorianCalendar gc = new GregorianCalendar(2010, 11, 06);
	java.sql.Date startDate = new java.sql.Date(gc.getTimeInMillis());

	GregorianCalendar gc1 = new GregorianCalendar(2011, 00, 01);
...
<%
	...
	try {
		...
		List<ConsumeData> dataList = service.getAllConsumeData(shopIds,
			...
			out.println("<h2>丁畅制造消费记录实时报表20101206－20110131:</h2>");
