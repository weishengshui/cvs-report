...
<%
	...
	GregorianCalendar gc = new GregorianCalendar(2010, 11, 01);
	java.sql.Date startDate = new java.sql.Date(gc.getTimeInMillis());

	GregorianCalendar gc1 = new GregorianCalendar(2010, 11, 31);
...
<%
	...
	try {
		...
		List<ConsumeData> dataList = service.getAllConsumeData(shopIds,
			...
			out.println("<h2>加州红消费记录实时报表20101201－20101230:</h2>");
