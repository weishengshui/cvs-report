...
<%
	...
	//总计报表
	FunctionCountVo vo = service.getQQMeishiActionHistoryLists(strStartFrom, strStartTo);

	//每日总计报表
	List<FunctionCountOfDayVo> fcdvs = service
			.getQQMeishiActionCountOfDay(strStartFrom, strStartTo);

	//商户汇总报表
	List<QQMeishiActionHistoryShopVO> historyShopVOs = service
			.getQQMeishiActionCountOfShop(strStartFrom, strStartTo);
