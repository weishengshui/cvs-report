...
<table width="400" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<ul>
			...
			<!-- 超级优惠开始 -->
			<li class="edge_003" onclick="javascript:clickMenu('Layer11');">
			<h2>超级优惠报表<rp:np date="20101221" /></h2>
			<div id="Layer11" class="list" style="display: none"><a
				href="<%=ctxRootPath%>/superpri/superpridatalist.jsp" target="right">超级优惠每周消费汇总<rp:np date="20101220" /></a> <br />
				<a
				href="<%=ctxRootPath%>/superpri/productitemcountforsupper.jsp" target="right">超级优惠项消费总计<rp:np date="20101221" /></a>
			</div>
			</li>
			...
			<div id="Layer1" class="list" style="display: none">
            <a href="<%=ctxRootPath%>/searchB2BRegisterShop.jsp" target="right">B2B注册商户信息资料报表</a><rp:np
				date="20101202" /><br />
            <a href="<%=ctxRootPath%>/searchMemberByParam.jsp" target="right">会员信息资料报表</a><rp:np
				date="20100524" /><br />
			...
			<li class="edge_003" onclick="javascript:clickMenu('Layer4');">
			<h2>搜房</h2>
			...
			<li class="edge_003" onclick="javascript:clickMenu('Layer5');">
			<h2>国寿</h2>
			<div id="Layer5" class="list" style="display: none"><a
				href="./guoshou.jsp" target="right"> 国寿会员注册报表</a> <br>
		    	<a href="./guoshoupoint.jsp" target="right"> 国寿会员消费报表</a> <br>
                <a href="./chinalifeexchangereport.jsp" target="right"> 国寿会员兑换报表</a></div>
			</li>

			<li class="edge_003" onclick="javascript:clickMenu('Layer6');">
			<h2>QQ</h2>
			...
			<li class="edge_003" onclick="javascript:clickMenu('Layer7');">
			<h2>青岛</h2>
 ...
 -->
			<li class="edge_003" onclick="javascript:clickMenu('Layer8');">
			<h2>外部对接报表</h2>
			<div id="Layer8" class="list" style="display: none"><a
	...
	活动支持报表 STARTS 
 -->
			<li class="edge_003" onclick="javascript:clickMenu('Layer9');">
			<h1>活动支持报表</h1>
			<div id="Layer9" class="list" style="display: none">
			<table>
				<thead>
					<tr>
						<th>日期</th>
				...
				<tbody>
					<tr>
						<td>2011-05-05 2011-05-31</td>
						<td>爱陶乐-国寿<rp:np date="20110516" /></td>
						<td><a href="activity/20110505_20110531_aitaole.jsp?shopId=13591&shopId=11280"
							target="right">爱陶乐消费者记录-国寿</a></td>
					</tr>
					<tr>
						<td>2010-12-01 ~ 2010-12-31</td>
						<td>太平洋电影城第四季活动报表<rp:np date="20101227" /></td>
						<td><a
							href="activity/20101201_20101231_pacificfilm_Teralane.jsp"
							target="right">太平洋电影城第四季活动消费者记录</a></td>
					</tr>
				    <tr>
						<td>2010-12-01 ~ 2010-12-30</td>
						<td>加州红活动报表<rp:np date="20101208" /></td>
						<td><a href="activity/201012_20101230_jzh.jsp?shopId=7881&shopId=7882&shopId=7880" target="right">加州红活动消费者记录</a></td>
					</tr>
				    <tr>
						<td>2010-12-06 ~ 2011-01-31</td>
						<td>丁畅制造活动报表<rp:np date="20101208" /></td>
						<td><a href="activity/20101206_20110131_dczz.jsp?shopId=562&shopId=6480&shopId=6481" target="right">丁畅制造活动消费者记录</a></td>
					</tr>
					<tr>
						<td>2010-11-15 ~ 2010-12-10</td>
						<td>四海一家&大饱口福活动报表<rp:np date="20101116" /></td>
						<td><a
							href="activity/20101115_20101210_dbkf_shyj.jsp?shopId=9580&shopId=10080&posId=RB-000000064&posId=RB-000000090"
							target="right">四海一家消费者记录</a></br>
                            <a
							href="activity/20101115_20101210_dbkf_shyj.jsp?shopId=9581&posId=RB-000000036&posId=RB-000000140"
							target="right">大饱口福消费者记录</a></td>
					</tr>
					<tr>
						<td>2010-10-01 ~ 2010-11-30</td>
						<td>太平洋电影城第三季活动报表<rp:np date="20101001" /></td>
						<td><a
							href="activity/20101001_20101130_pacificfilm_Teralane.jsp"
							target="right">太平洋电影城第三季活动消费者记录</a></td>
					</tr>
					<tr>
						<td>2010-09-05 ~ 2010-09-30</td>
						<td>丁畅制造活动报表<rp:np date="20100909" /></td>
						<td><a href="activity/20100909_dingchang.jsp" target="right">丁畅制造活动消费者记录</a></td>
					</tr>
					<tr>
						<td>2010-09-04 ~ 2010-12-03</td>
						<td>酷党四期活动报表<rp:np date="20100907" /></td>
						<td><a href="activity/20100907_coolparty_4.jsp"
							target="right">酷党四期活动消费者记录</a></td>
					</tr>
					<tr>
						<td>2010-08-28 ~ 2010-09-30</td>
						<td>太平洋电影城活动报表<rp:np date="20100901" /></td>
						<td><a href="activity/20100828_pacificfilm_Teralane.jsp"
							target="right">太平洋电影城（天利名城店）活动消费者记录</a></td>
					</tr>
					<tr>
 ...
 -->
			...
			<li class="edge_003" onclick="javascript:clickMenu('Layer10');">
			<h2>POS管理报表</h2>
			<div id="Layer10" class="list" style="display: none"><a
				href="<%=ctxRootPath%>/pos_maintenance.jsp" target="right">POS机管理报表(新)</a>
 ...
 -->
			<li class="edge_003" onclick="javascript:clickMenu('Layer100');">
	...
	function clickMenu(param) {
		if ("Layer9" == param) {
			if (document.getElementById(param).style.display == "") {
				...
				parent.document.getElementById('mainframe').cols = "30%,70%";
			}
		} else {
			if (parent.document.getElementById('mainframe').cols != "20%,80%") {
				parent.document.getElementById('mainframe').cols = "20%,80%";
