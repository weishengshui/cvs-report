...
out.println("<th></th>");
out.println("</tr>"); 
rs = stmt.executeQuery("select appellation, chisurname, chifirstname, cardnumber, gender, address, mobilephone,status,signupat,logmessage,datasource from membersignup where datasource!='BATCH_IMPORT' ORDER by signupat desc");
