...
<%
	/**
	 * This report is created for the activity of 太平洋电影城（天利名城店）活动报表
	 *
	 */
	...
	String targetMerchantBizName = "太平洋电影城（天利名城店）"; //太平洋电影城

	List<String> targetShopIds = new ArrayList<String>();

	String sTransdateFrom = "2010-08-28"; // should be 2010-03-16
	...
	try {
		...
		String sql = "select DISTINCT shopid from clubpoint where shopname = '"
...
<html>
<head>
<title>2010-06-01 太平洋影院活动报表</title>
<style type="text/css">
.mgrp_sep {
...
.xact_lv1 { /*background-color: #FFFC40;*/
	
}

/* transaction amount >= ? level 2 */
.xact_lv2 { /*background-color: #F57676;*/
